//this script uses stackreg plug in - make sure you have StackReg and TurboReg installed in your imagej
//under analyze - set measurements - check the following: Area, Standard deviation, shape descriptors, mean gray value
//masterdir is where the 'images' folder that contains subdirectories with images collected on different dates or however you sort them
...
for (l=0; l<masterlist.length; l++) {
	...
	for (fIdx=0; fIdx<files.length; fIdx++) {
		...
		saveAs("Results",saveto+subdirname+"_Results.csv");
