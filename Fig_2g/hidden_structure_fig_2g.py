...
# 
# Figures 2G, 3E, S5: Heatmap of Re values for various IDRs in various solution conditions
#
# 2G: Naturally occurring IDRs. 3E: PUMA BH3 and scrambles. S5: GS polymers of various lengths.
#
...
# IDR_SET = 'pumas' # Uncomment for Fig 3E
...
if IDR_SET == 'idrs':
    ...
    fig.savefig('hidden_structure_fig_3e.png', bbox_inches='tight')
elif IDR_SET == 'gs':
